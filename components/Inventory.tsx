...
const Inventory: React.FC = () => {
  ...
  const [newProduct, setNewProduct] = useState<Partial<Product>>({
    name: '', hsn: '', rate: 0, unit: 'NOS', stock: 0, gstPercent: 18, warehouseId: ''
  });
  ...
  const handleAddNewProduct = (e: React.FormEvent) => {
    ...
    setNewProduct({ name: '', hsn: '', rate: 0, unit: 'NOS', stock: 0, gstPercent: 18, warehouseId: '' });
  };
    ...
    <div className="space-y-6 lg:space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 lg:gap-8">
        ...
        <div className="bg-orange-50 p-6 lg:p-8 rounded-3xl lg:rounded-[2.5rem] shadow-sm border border-orange-100">
          ...
          <h3 className="text-3xl lg:text-4xl font-black text-orange-800">{products.filter(p => p.stock < 10).length}</h3>
        </div>
